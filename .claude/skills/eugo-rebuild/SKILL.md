...
2. Fallback (eugo-kb unavailable): read
   ...
   `eugo-skills pull --from /opt/eugo/athena --cache --name eugo-rebuild-base`.
...
# DURABLE HOME of every value below: .eugo.toml [skills.adapters."eugo-rebuild"] — this block is REGENERATED by `eugo-skills pull --as-adapter`; an edit made here is overwritten.
params:

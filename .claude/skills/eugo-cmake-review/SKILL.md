...
2. Fallback (eugo-kb unavailable): read
   ...
   `eugo-skills pull --from /opt/eugo/athena --cache --name eugo-cmake-review-base`.
...
# DURABLE HOME of every value below: .eugo.toml [skills.adapters."eugo-cmake-review"] — this block is REGENERATED by `eugo-skills pull --as-adapter`; an edit made here is overwritten.
params:
  audit_cmd: ""
